...
public class FarmTimerSmallMain extends Application {

	@Override
	public void start(Stage stage) throws IOException {
		FXMLLoader fxmlLoader = new FXMLLoader(FarmTimerMain.class.getResource("/bdoftsmall.fxml"));
		Parent root = fxmlLoader.load();
		Scene scene = new Scene(root);

		ControllerSmall controller = (ControllerSmall) fxmlLoader.getController();
